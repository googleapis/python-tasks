...
class Queue(proto.Message):
    ...
    app_engine_http_target = proto.Field(proto.MESSAGE, number=3, oneof='target_type',
        message=target.AppEngineHttpTarget,
    )

    pull_target = proto.Field(proto.MESSAGE, number=4, oneof='target_type',
        message=target.PullTarget,
    )

    rate_limits = proto.Field(proto.MESSAGE, number=5,
        message='RateLimits',
    )

    retry_config = proto.Field(proto.MESSAGE, number=6,
        message='RetryConfig',
    )
    ...
    purge_time = proto.Field(proto.MESSAGE, number=8,
        message=timestamp.Timestamp,
    )

    task_ttl = proto.Field(proto.MESSAGE, number=9,
        message=duration.Duration,
    )

    tombstone_ttl = proto.Field(proto.MESSAGE, number=10,
        message=duration.Duration,
    )

    stats = proto.Field(proto.MESSAGE, number=16,
        message='QueueStats',
    )
...
class RetryConfig(proto.Message):
    ...
    max_retry_duration = proto.Field(proto.MESSAGE, number=3,
        message=duration.Duration,
    )

    min_backoff = proto.Field(proto.MESSAGE, number=4,
        message=duration.Duration,
    )

    max_backoff = proto.Field(proto.MESSAGE, number=5,
        message=duration.Duration,
    )
