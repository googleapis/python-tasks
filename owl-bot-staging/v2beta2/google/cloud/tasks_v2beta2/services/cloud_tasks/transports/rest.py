...
class CloudTasksRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_acknowledge_task(self, request: cloudtasks.AcknowledgeTaskRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudtasks.AcknowledgeTaskRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_cancel_lease(self, request: cloudtasks.CancelLeaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudtasks.CancelLeaseRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_task(self, response: task.Task) -> task.Task:
        ...
        """
        return response
    def pre_lease_tasks(self, request: cloudtasks.LeaseTasksRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudtasks.LeaseTasksRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_lease_tasks(self, response: cloudtasks.LeaseTasksResponse) -> cloudtasks.LeaseTasksResponse:
    ...
    def post_purge_queue(self, response: queue.Queue) -> queue.Queue:
        ...
        """
        return response
    def pre_renew_lease(self, request: cloudtasks.RenewLeaseRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[cloudtasks.RenewLeaseRequest, Sequence[Tuple[str, str]]]:
...
class CloudTasksRestTransport(CloudTasksTransport):
    ...
    class _AcknowledgeTask(CloudTasksRestStub):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_acknowledge_task(request, metadata)
