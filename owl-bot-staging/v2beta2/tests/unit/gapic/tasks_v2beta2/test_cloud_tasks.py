...
def test_upload_queue_yaml(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.upload_queue_yaml),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_upload_queue_yaml_async(transport: str = 'grpc_asyncio', request_type=cloudtasks.UploadQueueYamlRequest):
    client = CloudTasksAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_queues_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2beta2/{parent=projects/*/locations/*}/queues" % client.transport._host, args[1])
...
def test_get_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{name=projects/*/locations/*/queues/*}" % client.transport._host, args[1])
...
def test_update_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{queue.name=projects/*/locations/*/queues/*}" % client.transport._host, args[1])
...
def test_purge_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{name=projects/*/locations/*/queues/*}:purge" % client.transport._host, args[1])
...
def test_pause_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{name=projects/*/locations/*/queues/*}:pause" % client.transport._host, args[1])
...
def test_resume_queue_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{name=projects/*/locations/*/queues/*}:resume" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{resource=projects/*/locations/*/queues/*}:getIamPolicy" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{resource=projects/*/locations/*/queues/*}:setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{resource=projects/*/locations/*/queues/*}:testIamPermissions" % client.transport._host, args[1])
...
def test_list_tasks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{parent=projects/*/locations/*/queues/*}/tasks" % client.transport._host, args[1])
...
def test_get_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{name=projects/*/locations/*/queues/*/tasks/*}" % client.transport._host, args[1])
...
def test_lease_tasks_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = cloudtasks.LeaseTasksResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_lease_tasks_rest_required_fields(request_type=cloudtasks.LeaseTasksRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).lease_tasks._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_lease_tasks_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "leaseDuration", )))
...
def test_lease_tasks_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudTasksRestInterceptor, "post_lease_tasks") as post, \
         mock.patch.object(transports.CloudTasksRestInterceptor, "pre_lease_tasks") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloudtasks.LeaseTasksResponse.to_json(cloudtasks.LeaseTasksResponse())
        ...
        client.lease_tasks(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_lease_tasks_rest_bad_request(transport: str = 'rest', request_type=cloudtasks.LeaseTasksRequest):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_lease_tasks_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{parent=projects/*/locations/*/queues/*}/tasks:lease" % client.transport._host, args[1])
...
def test_acknowledge_task_rest_required_fields(request_type=cloudtasks.AcknowledgeTaskRequest):
    transport_class = transports.CloudTasksRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).acknowledge_task._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_acknowledge_task_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "scheduleTime", )))
...
def test_acknowledge_task_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudTasksRestInterceptor, "pre_acknowledge_task") as pre:
        pre.assert_not_called()
        pb_message = cloudtasks.AcknowledgeTaskRequest.pb(cloudtasks.AcknowledgeTaskRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.acknowledge_task(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_acknowledge_task_rest_bad_request(transport: str = 'rest', request_type=cloudtasks.AcknowledgeTaskRequest):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_acknowledge_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{name=projects/*/locations/*/queues/*/tasks/*}:acknowledge" % client.transport._host, args[1])
...
def test_renew_lease_rest_required_fields(request_type=cloudtasks.RenewLeaseRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).renew_lease._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_renew_lease_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "scheduleTime", "leaseDuration", )))
...
def test_renew_lease_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudTasksRestInterceptor, "post_renew_lease") as post, \
         mock.patch.object(transports.CloudTasksRestInterceptor, "pre_renew_lease") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_renew_lease_rest_bad_request(transport: str = 'rest', request_type=cloudtasks.RenewLeaseRequest):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_renew_lease_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{name=projects/*/locations/*/queues/*/tasks/*}:renewLease" % client.transport._host, args[1])
...
def test_cancel_lease_rest_required_fields(request_type=cloudtasks.CancelLeaseRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).cancel_lease._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_cancel_lease_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CloudTasksRestInterceptor, "post_cancel_lease") as post, \
         mock.patch.object(transports.CloudTasksRestInterceptor, "pre_cancel_lease") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.cancel_lease(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_cancel_lease_rest_bad_request(transport: str = 'rest', request_type=cloudtasks.CancelLeaseRequest):
    client = CloudTasksClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_cancel_lease_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{name=projects/*/locations/*/queues/*/tasks/*}:cancelLease" % client.transport._host, args[1])
...
def test_run_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{name=projects/*/locations/*/queues/*/tasks/*}:run" % client.transport._host, args[1])
...
def test_buffer_task_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2beta2/{queue=projects/*/locations/*/queues/*}/tasks/{task_id}:buffer" % client.transport._host, args[1])
...
def test_cloud_tasks_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.tasks_v2beta2.services.cloud_tasks.transports.CloudTasksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_cloud_tasks_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.tasks_v2beta2.services.cloud_tasks.transports.CloudTasksTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CloudTasksTransport()
        adc.assert_called_once()
