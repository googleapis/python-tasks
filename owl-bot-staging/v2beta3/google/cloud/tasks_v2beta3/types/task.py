...
class Task(proto.Message):
    ...
    http_request = proto.Field(proto.MESSAGE, number=11, oneof='payload_type',
        message=target.HttpRequest,
    )

    pull_message = proto.Field(proto.MESSAGE, number=13, oneof='payload_type',
    ...
    dispatch_deadline = proto.Field(proto.MESSAGE, number=12,
    ...
    first_attempt = proto.Field(proto.MESSAGE, number=8,
        message='Attempt',
    )

    last_attempt = proto.Field(proto.MESSAGE, number=9,
        message='Attempt',
    )

    view = proto.Field(proto.ENUM, number=10,
        enum=View,
    )
