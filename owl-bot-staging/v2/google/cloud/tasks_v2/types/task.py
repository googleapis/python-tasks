...
class Task(proto.Message):
    ...
    app_engine_http_request = proto.Field(proto.MESSAGE, number=2, oneof='message_type',
        message=target.AppEngineHttpRequest,
    )

    http_request = proto.Field(proto.MESSAGE, number=3, oneof='message_type',
        message=target.HttpRequest,
    )

    schedule_time = proto.Field(proto.MESSAGE, number=4,
    ...
    dispatch_deadline = proto.Field(proto.MESSAGE, number=6,
    ...
    first_attempt = proto.Field(proto.MESSAGE, number=9,
        message='Attempt',
    )

    last_attempt = proto.Field(proto.MESSAGE, number=10,
        message='Attempt',
    )

    view = proto.Field(proto.ENUM, number=11,
        enum=View,
    )
