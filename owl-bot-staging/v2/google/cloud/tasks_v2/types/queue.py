...
class Queue(proto.Message):
    ...
    app_engine_routing_override = proto.Field(proto.MESSAGE, number=2,
        message=target.AppEngineRouting,
    )

    rate_limits = proto.Field(proto.MESSAGE, number=3,
        message='RateLimits',
    )

    retry_config = proto.Field(proto.MESSAGE, number=4,
        message='RetryConfig',
    )
    ...
    purge_time = proto.Field(proto.MESSAGE, number=6,
        message=timestamp.Timestamp,
    )

    stackdriver_logging_config = proto.Field(proto.MESSAGE, number=9,
