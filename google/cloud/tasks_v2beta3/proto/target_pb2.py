...
HttpRequest = _reflection.GeneratedProtocolMessageType('HttpRequest', (_message.Message,), {
  ...
  limits][google.cloud.tasks.v2beta3.Queue.rate_limits], and the
  [queue’s state][google.cloud.tasks.v2beta3.Queue.state].  -  System
  ...
  in [rate limits][google.cloud.tasks.v2beta3.Queue.rate_limits] will
  ...
  ``Retry-After`` HTTP response header is considered.  -  To prevent
  traffic spikes and to smooth sudden increases in traffic,
  ...
  Attributes:
      ...
      body:
          ...
          [HTTP
          method][google.cloud.tasks.v2beta3.HttpRequest.http_method] is
          POST, PUT, or PATCH. It is an error to set body on a task with
          an incompatible
...
AppEngineHttpQueue = _reflection.GeneratedProtocolMessageType('AppEngineHttpQueue', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.tasks_v2beta3.proto.target_pb2'
  ,
  '__doc__': """App Engine HTTP queue.  The task will be delivered to the App Engine
  application hostname specified by its
  [AppEngineHttpQueue][google.cloud.tasks.v2beta3.AppEngineHttpQueue]
  and [AppEngineHttpRequest][google.cloud.tasks.v2beta3.AppEngineHttpReq
  uest]. The documentation for [AppEngineHttpRequest][google.cloud.tasks
  .v2beta3.AppEngineHttpRequest] explains how the task’s host URL is
  constructed.  Using
  [AppEngineHttpQueue][google.cloud.tasks.v2beta3.AppEngineHttpQueue]
  ...
  Attributes:
      app_engine_routing_override:
          ...
          .tasks.v2beta3.AppEngineHttpRequest.app_engine_routing].  If
          set, ``app_engine_routing_override`` is used for all tasks in
          the queue, no matter what the setting is for the [task-level a
          pp_engine_routing][google.cloud.tasks.v2beta3.AppEngineHttpReq
          uest.app_engine_routing].
  """,
...
AppEngineHttpRequest = _reflection.GeneratedProtocolMessageType('AppEngineHttpRequest', (_message.Message,), {
  ...
  [AppEngineRouting][google.cloud.tasks.v2beta3.AppEngineRouting] used
  to construct the URL that the task is delivered to can be set at the
  queue-level or task-level:  -  If set,    [app_engine_routing_override
  ][google.cloud.tasks.v2beta3.AppEngineHttpQueue.app_engine_routing_ove
  rride]    is used for all tasks in the queue, no matter what the
  setting is for    the [task-level    app_engine_routing][google.cloud.
  tasks.v2beta3.AppEngineHttpRequest.app_engine_routing].  The ``url``
  that the task will be sent to is:  -  ``url =``
  [host][google.cloud.tasks.v2beta3.AppEngineRouting.host]    ``+``    [
  relative_uri][google.cloud.tasks.v2beta3.AppEngineHttpRequest.relative
  _uri]  Tasks can be dispatched to secure app handlers, unsecure app
  ...
  the [deadline][google.cloud.tasks.v2beta3.Task.dispatch_deadline].
  ...
  Attributes:
      ...
      app_engine_routing:
          ...
          eue.app_engine_routing_override] is used for all tasks in the
          queue, no matter what the setting is for the [task-level app_e
          ngine_routing][google.cloud.tasks.v2beta3.AppEngineHttpRequest
          .app_engine_routing].
      relative_uri:
