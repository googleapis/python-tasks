...
_LISTQUEUESRESPONSE.fields_by_name['queues'].message_type = google_dot_cloud_dot_tasks__v2_dot_proto_dot_queue__pb2._QUEUE
_CREATEQUEUEREQUEST.fields_by_name['queue'].message_type = google_dot_cloud_dot_tasks__v2_dot_proto_dot_queue__pb2._QUEUE
_UPDATEQUEUEREQUEST.fields_by_name['queue'].message_type = google_dot_cloud_dot_tasks__v2_dot_proto_dot_queue__pb2._QUEUE
_UPDATEQUEUEREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_LISTTASKSREQUEST.fields_by_name['response_view'].enum_type = google_dot_cloud_dot_tasks__v2_dot_proto_dot_task__pb2._TASK_VIEW
_LISTTASKSRESPONSE.fields_by_name['tasks'].message_type = google_dot_cloud_dot_tasks__v2_dot_proto_dot_task__pb2._TASK
_GETTASKREQUEST.fields_by_name['response_view'].enum_type = google_dot_cloud_dot_tasks__v2_dot_proto_dot_task__pb2._TASK_VIEW
_CREATETASKREQUEST.fields_by_name['task'].message_type = google_dot_cloud_dot_tasks__v2_dot_proto_dot_task__pb2._TASK
_CREATETASKREQUEST.fields_by_name['response_view'].enum_type = google_dot_cloud_dot_tasks__v2_dot_proto_dot_task__pb2._TASK_VIEW
_RUNTASKREQUEST.fields_by_name['response_view'].enum_type = google_dot_cloud_dot_tasks__v2_dot_proto_dot_task__pb2._TASK_VIEW
...
ListQueuesRequest = _reflection.GeneratedProtocolMessageType('ListQueuesRequest', (_message.Message,), {
  ...
  Attributes:
      ...
      page_size:
          ...
          use the [next_page_token][google.cloud.tasks.v2.ListQueuesResp
          onse.next_page_token] in the response to determine if more
          queues exist.
      page_token:
          ...
          t_page_token][google.cloud.tasks.v2.ListQueuesResponse.next_pa
          ge_token] returned from the previous call to
          [ListQueues][google.cloud.tasks.v2.CloudTasks.ListQueues]
...
ListQueuesResponse = _reflection.GeneratedProtocolMessageType('ListQueuesResponse', (_message.Message,), {
  ...
  Attributes:
      ...
      next_page_token:
          ...
          this value as the [page_token][google.cloud.tasks.v2.ListQueue
          sRequest.page_token].  If the next_page_token is empty, there
          are no more results.  The page token is valid for only 2
          hours.
  """,
...
ListTasksRequest = _reflection.GeneratedProtocolMessageType('ListTasksRequest', (_message.Message,), {
  ...
  Attributes:
      ...
      page_size:
          ...
          le.cloud.tasks.v2.ListTasksResponse.next_page_token] in the
          response to determine if more tasks exist.  The maximum page
          size is 1000. If unspecified, the page size will be the
          maximum.
      page_token:
          A token identifying the page of results to return.  To request
          the first page results, page_token must be empty. To request
          the next page of results, page_token must be the value of [nex
          t_page_token][google.cloud.tasks.v2.ListTasksResponse.next_pag
          e_token] returned from the previous call to
          [ListTasks][google.cloud.tasks.v2.CloudTasks.ListTasks]
...
ListTasksResponse = _reflection.GeneratedProtocolMessageType('ListTasksResponse', (_message.Message,), {
  ...
  Attributes:
      ...
      next_page_token:
          ...
          this value as the [page_token][google.cloud.tasks.v2.ListTasks
          Request.page_token].  If the next_page_token is empty, there
          are no more results.
  """,
