...
class Task(proto.Message):
    ...
    schedule_time = proto.Field(proto.MESSAGE, number=5, message=timestamp.Timestamp,)
...
class AttemptStatus(proto.Message):
    ...
    response_status = proto.Field(proto.MESSAGE, number=4, message=gr_status.Status,)
