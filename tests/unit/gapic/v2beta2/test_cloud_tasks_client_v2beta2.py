...
class TestCloudTasksClient(object):
    ...
    def test_lease_tasks(self):
        ...
        assert len(channel.requests) == 1
        expected_request = cloudtasks_pb2.LeaseTasksRequest(parent=parent, lease_duration=lease_duration)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_acknowledge_task(self):
        ...
        assert len(channel.requests) == 1
        expected_request = cloudtasks_pb2.AcknowledgeTaskRequest(name=name, schedule_time=schedule_time)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_renew_lease(self):
        ...
        assert len(channel.requests) == 1
        expected_request = cloudtasks_pb2.RenewLeaseRequest(name=name, schedule_time=schedule_time, lease_duration=lease_duration)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_cancel_lease(self):
        ...
        assert len(channel.requests) == 1
        expected_request = cloudtasks_pb2.CancelLeaseRequest(name=name, schedule_time=schedule_time)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
