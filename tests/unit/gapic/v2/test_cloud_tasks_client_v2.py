...
class TestCloudTasksClient(object):
    ...
    def test_get_task(self):
        ...
        expected_response = {'name': name_2, 'dispatch_count': dispatch_count, 'response_count': response_count}
    ...
    def test_create_task(self):
        ...
        dispatch_count = 1217252086
        response_count = 424727441
        expected_response = {'name': name, 'dispatch_count': dispatch_count, 'response_count': response_count}
        expected_response = task_pb2.Task(**expected_response)
